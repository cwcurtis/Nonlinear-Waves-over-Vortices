function waves_over_vortices(K,mu,gam,F,tf)
    ...
    %xpos = [-5*mu*gam/2;-3*mu*gam/2;3*mu*gam/2;5*mu*gam/2];
    ...
    %plot(Xmesh,eta0p,'k-.',Xmesh,fst_plot,'k--',Xmesh,eta,'k','LineWidth',2)
    set(gca,'FontSize',30,'FontName','Helvetica','FontWeight','bold')
    xlabel('x','FontName','Helvetica','FontSize',30,'FontWeight','bold')
    ylabel('\eta(x,t)','FontName','Helvetica','FontSize',30,'FontWeight','bold')
    ...
    plot(-K+1:K,pspec,'k',-K+1:K,log10(abs(fftshift(fft(scd_plot)))),'LineWidth',2)
    set(gca,'FontSize',30,'FontName','Helvetica','FontWeight','bold')
    ...
    figure(4)
    plot(times,energy_plot,'k',times,p_energy_plot,'k--',times,k_energy_plot,'k-.','LineWidth',2)
    set(gca,'FontSize',30,'FontName','Helvetica','FontWeight','bold')
