function waves_over_vortices_multipole(rows,cols,K,mu,gam,ep,F,tf,Ntrunc)
    close all
    Gamma = 4;
...
% % % % % % % % % % % % % % % % % % % % % % % %
    ...
    for jj=1:nmax
        ...
        [u,xpos,zpos] = vort_update_multipole(Xmesh,gam,mu,ep,F,u,gvals,L1,no_dno_term,Nvorts,Ntrunc,Ehdt,Edt,xpos,zpos,dt,2*KT);
