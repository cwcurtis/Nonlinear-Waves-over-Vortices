...
%\includegraphics[width=.48\textwidth]{surf_resp_cnoid_mu_pt2_F_pt2_tf_5NEW}
%\end{tabular}
%\caption{\small Surface response $\eta(x,5)$ for a traveling cnoidal solution of the KdV equation with elliptic modulus $\tilde{m}=0.2$ and Froude number $F=0.02$ (Left Panel) and $F=.2$ (Right Panel). The increased Froude number allows for stronger deformation of the surface wave by the rising vortices.}
